...
def on_press(key):
    global STOP, START, RECORD_TOGGLE, TACTILE_VR_OVERLAY_VISIBLE
    if key == 'r':
        START = True
    elif key == 'q':
        START = False
...
if __name__ == '__main__':
    ...
    parser.add_argument('--neck-log-rate', type=float, default=1.0, help='Neck debug log rate in Hz. Set 0 to disable periodic neck logs.')
